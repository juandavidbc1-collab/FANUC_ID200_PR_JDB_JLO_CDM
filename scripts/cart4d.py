...
PRE_PICK=[0.643493,0.423444,-0.047642,0.0,-1.099710,-0.643493]
P0=np.array([0.40,0.30,0.43]); P1=np.array([0.40,0.30,0.28])
T=6.5804; N=60
...
def main():
    ...
    fig.tight_layout(); fig.savefig("/home/juan-david-botero/ws_fanuc/scripts/articular_4D.png",dpi=130)
    np.savez("/home/juan-david-botero/ws_fanuc/scripts/traj_4D.npz",
             **{f"{k}_{v}":out[k][i] for k in out for i,v in enumerate(["t","Q","V","A","X"])})
    print("Grafica: ~/ws_fanuc/scripts/articular_4D.png")
    rclpy.shutdown()
